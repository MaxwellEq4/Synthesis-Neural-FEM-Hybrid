...
fig.show()
fig.write_image("poisson_3d_neubc.png")
fig.write_image("poisson_3d_neubc.pdf")
...
fig.show()
fig.write_image("poisson_3d_dirbc.png")
fig.write_image("poisson_3d_dirbc.pdf")
...
# Save figure
fig.write_image("poisson_2d_dirbc.png")
fig.write_image("poisson_2d_dirbc.pdf")